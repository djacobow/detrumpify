...
monikers = {
  ...
  'putin': {
    'clean': [
      'Мутантний Кліщ', 'Mutant Tick',
      'Таємний Нацист', 'Secret Nazi',
      'Боягузливий Отруйний', 'Cowardly Poisoner',
      'Позолочений Унітаз', 'Gilded Toilet',
      'КГБ Папики', 'KGB Sugar Daddy',
      'Доктор Стрейнджлав', 'Doctor Strangelog',
      'Putain de Merge',
      'Тато Уорбакс', 'Daddy Warbucks',
      'Rосійський Bбивця', 'Russian Killer',
      'Святий Новичок', 'Saint Novichok',
      'Elmer Fudd\'s Twin',
      'Ще один надзвичайно стабільний геній', 'Another Extremely Stable Genius',
      'Вершник Трампа', 'Trump\'s Rider',
      'Верховний Клептократ', 'Supreme Kleptocrat',
      'Мерзотник',
      'Окурок', 'Cigarete Butt',
      'Краб', 'Crab',
      'Пыня',
      'Старик Кабаев', 'Old Man Kabayev',
      'Пукин',
      'Мистер Пу',
      'Путлер',
      'Ботоксный', 'Old Botox',
